...
#pragma warning restore 0618
        ...
        protected bool SetState(GestureRecognizerState value)
        {
            ...
            (
                ...
                requireGestureRecognizerToFail != null &&
                value == GestureRecognizerState.Ended &&
                requireGestureRecognizerToFail.state == GestureRecognizerState.Possible &&
                (requireGestureRecognizerToFail.CurrentTrackedTouches.Count != 0 || requireGestureRecognizerToFail.justEnded) &&
                !requireGestureRecognizerToFail.justFailed
            )
            {
        ...
        public void ProcessTouchesEnded(ICollection<GestureTouch> touches)
        {
            ...
            try
            {
                ...
                // if we don't have touches we care about, return
                if (!TouchesIntersect(touches, currentTrackedTouches))
                {
                    return;
                }
